...
class BaseTask:
    ...
    :param input_files: list of files that needs to be packaged along with the entry point.
           E.g. local python modules, trained model weights, etc. If the list contains 
           'requirements.txt', python packages mentioned in requirements.txt will be installed
           in the built docker image.
    """
